...
function initIcicle(args){
    
        
  $('#container3').css('display','block').html('<div id="center-container" class="span11"><div id="infovis" class="span11"></div></div><div class="span1" id="log"></div>');     
    
        
  // init data

    var json = JSON.parse(args.testdata);//serialized data from server
   // console.log("Icicle default--"+JSON.stringify(json));  
    //console.log("Icicle--"+JSON.stringify(json2));  
  // end
  // init Icicle
